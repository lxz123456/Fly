...
public class ShootGame extends JPanel {
	...
	static { // 锟斤拷态锟斤拷锟斤拷椋拷锟绞硷拷锟酵计拷锟皆�
		try {
			background = ImageIO.read(ShootGame.class.getResource("bg.jpg"));
			start = ImageIO.read(ShootGame.class.getResource("start.png"));
			airplane = ImageIO
					.read(ShootGame.class.getResource("cier1.png"));
			bee = ImageIO.read(ShootGame.class.getResource("ba2.png"));
			bullet = ImageIO.read(ShootGame.class.getResource("123.png"));
			hero0 = ImageIO.read(ShootGame.class.getResource("plane.png"));
			hero1 = ImageIO.read(ShootGame.class.getResource("plane.png"));
...
//			System.out.println("sfsd"+b.getX()+b.getY());
	...
	public void paintScore(Graphics g) {
		int x = 10; // x锟斤拷锟斤拷
		int y = 25; // y锟斤拷锟斤拷
		Font font = new Font(Font.SANS_SERIF, Font.BOLD, 14); // 锟斤拷锟斤拷
...
//		frame.setIconImage(new ImageIcon("images/icon.jpg").getImage()); // 锟斤拷锟矫达拷锟斤拷锟酵硷拷锟�
	...
	public void action() {
		// 锟斤拷锟斤拷锟斤拷锟铰硷拷
		//MouseAdapter锟矫碉拷锟侥革拷锟铰硷拷锟斤拷写锟侥革拷锟铰硷拷
		MouseAdapter l = new MouseAdapter() {
			...
			public void mouseExited(MouseEvent e) { // 锟斤拷锟斤拷顺锟�
				if (state != GAME_OVER) { // 锟斤拷戏未锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷为锟斤拷停
					state = PAUSE;
				}
			}
		...
		this.addMouseListener(l); // 锟斤拷锟斤拷锟斤拷锟揭伙拷锟斤拷锟斤拷
		...
		timer.schedule(new TimerTask() {
			...
			public void run() {
				if (state == RUNNING) { // 锟斤拷锟斤拷状态
					...
					bangAction(); // 锟接碉拷锟斤拷锟斤拷锟斤拷锟�,锟接碉拷锟酵碉拷锟剿碉拷锟斤拷撞
	...
	/** 锟斤拷一锟斤拷 */
	public void stepAction() {//10锟斤拷锟斤拷锟斤拷一锟斤拷
...
//	}
	...
	/** 锟斤拷锟� */
	public void shootAction() {//10锟斤拷锟斤拷锟斤拷一锟斤拷
		shootIndex++;//每10锟斤拷锟斤拷锟斤拷锟斤拷1
	...
	public void bang(Bullet bullet) {
		...
		if (index != -1) { // 锟叫伙拷锟叫的凤拷锟斤拷锟斤拷
			...
			if (one instanceof Award) { // 锟斤拷为锟斤拷锟斤拷锟斤拷锟斤拷锟矫斤拷锟斤拷
				Award a = (Award) one;
